...
if __name__ == "__main__":
    ...
    encoder = keras.Model([img_input, label_input], [z_mean, z_log_var, z], name="encoder")
    encoder.summary()
    ...
    for epoch in range(1, epochs + 1):
        ...
        history = cvae.fit([x_train, y_train_cat], epochs=1, batch_size=batch_size, verbose=2)
    ...
    while True:
        try:
            user_input = input("Podaj cyfrę (0-9), którą chcesz wygenerować (lub 'q' aby zakończyć): ")
